...
if __name__ == '__main__':
    # Test the manager
    manager = JSONManager('test_pdf', output_base_dir='.')
    ...
    sample_mcqs = [
        {
            ...
            "options": ["Software", "Hardware", "Algorithms", "Telecommunication"],
            "correct": "Algorithms",
        ...
        {
            "id": 2,
            "question": "What does computer hardware encompass?",
            "options": [
            ...
            "correct": "Both external and internal components",
            "explanation": "Hardware includes all physical components of a computer system.",
            "difficulty": "Easy",
            "importance": 2
        }
    ]
    ...
    # Add and save
    manager.add_mcqs(sample_mcqs, 'mids')
    manager.add_mcqs(sample_mcqs, 'finals')
